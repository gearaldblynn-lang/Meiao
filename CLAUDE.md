...
- **#81 ✅ 本地已修、待部署(2026-07-28)· 口播翻译按整段慢放，保留原背景又把旧口播残留和分离伪影带入成品**
...
- **#82 ✅ 全局修复已发布并完成故障账号资源链验收(2026-07-29)· 受保护素材在项目卡、上传栏和大图预览反复破图**
...
- **#83 ✅ 已发布并完成真实资源链验收(2026-07-29)· 受保护公共模特图被 direct-first 重新变成 KIE 无权读取的正式域名直链**
...
- **#84 ✅ 已修(2026-07-28)· 持久音色试听把目标语言算进身份，同一音色切语言仍重复付费生成**
