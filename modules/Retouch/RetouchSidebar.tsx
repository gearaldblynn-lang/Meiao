          ...
          <section className="space-y-6 pt-4 border-t border-slate-100">
            ...
            <div className="space-y-2">
              ...
              <div className="flex bg-slate-100 p-1 rounded-xl">
                {MODEL_OPTIONS.map(m => (
                  <button key={m} onClick={() => { setModel(m); setQuality(getDefaultQualityForModel(m)); }} className={`flex-1 py-1.5 text-[10px] font-black rounded-lg transition-all ${model === m ? 'bg-white text-emerald-600 shadow-sm border border-slate-200' : 'text-slate-400'}`}>
