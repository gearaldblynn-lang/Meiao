...
export const VOICEOVER_DEFAULTS = Object.freeze({
  ...
  readinessModelTimeoutMs: 60_000,
...
export const VOICEOVER_BOUNDS = Object.freeze({
  ...
  readinessModelTimeoutMs: Object.freeze([30_000, 90_000]),
  readinessRetryDelayMs: Object.freeze([5_000, 300_000]),
...
export function getVoiceoverConfig(env = {}) {
  return {
    ...
    readinessRetryDelayMs: boundedNumber(
      env.MEIAO_VOICEOVER_READINESS_RETRY_DELAY_MS,
      VOICEOVER_DEFAULTS.readinessRetryDelayMs,
      VOICEOVER_BOUNDS.readinessRetryDelayMs,
      true,
    ),
