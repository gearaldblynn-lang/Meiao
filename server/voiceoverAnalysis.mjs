...
export function buildVoiceoverAnalysisMessages({
  ...
  const prompt = [
    ...
    '15. For each segment, startMs is the first actually audible speech sound and endMs is the last actually audible speech sound for that same line.',
    '16. Leave every real leading, inter-line, and trailing silence gap unassigned; never stretch segment windows to fill the video.',
    '17. Do not force adjacent segments to share one boundary. Preserve the measured silent gap unless the speech is genuinely continuous.',
    '18. Use visible subtitle changes and visual action changes to cross-check the semantic boundary, while audio onset and offset remain authoritative.',
    '19. Do not round or regularize timestamps into evenly spaced or convenient values. Derive each boundary from the supplied media evidence.',
    '',
    'F Format',
