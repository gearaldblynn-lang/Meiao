...
import { LegacyFaIcon, WorkspaceShellCard } from '../../components/ui/workspacePrimitives';
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            {canManage ? (
              <div className="inline-flex rounded-[18px] border border-slate-200/80 bg-white/86 p-1">
                <button
                  ...
                  className={`rounded-[14px] px-3.5 py-2 text-[13px] font-black transition ${
                    workspaceMode === 'factory' ? 'bg-[color:var(--accent)] text-white' : 'text-[color:var(--text-secondary)]'
                  }`}
                >
                  智能体工厂
                </button>
                <button
                  ...
                  className={`rounded-[14px] px-3.5 py-2 text-[13px] font-black transition ${
                    workspaceMode === 'plaza' ? 'bg-[color:var(--accent)] text-white' : 'text-[color:var(--text-secondary)]'
                  }`}
                >
                  智能体广场
                </button>
              ...
              <div className="inline-flex items-center gap-2 rounded-[18px] border border-slate-200/80 bg-white/88 px-3 py-2 text-[12px] font-semibold text-slate-500">
                <LegacyFaIcon icon="fa-robot" className="text-[11px] text-slate-400" />
                <span>内部智能体工作台</span>
              </div>
            )}
