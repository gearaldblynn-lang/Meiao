...
export const ACTION_LABELS: Record<string, string> = {
  ...
  provider_submit_started: '开始提交上游',
  provider_submit_succeeded: '上游提交完成',
  provider_submit_failed: '上游提交失败',
  job_completed: '内部任务完成',
  job_failed: '内部任务失败',
  job_retry_waiting: '内部任务重试中',
  job_cancel_requested: '请求取消任务',
  job_retry_requested: '请求重试任务',
  frontend_runtime_error: '前端运行错误',
  frontend_unhandled_rejection: '前端异步错误',
  frontend_startup_diagnostics: '前端启动诊断',
  frontend_previous_session_interrupted: '前端会话异常中断',
  shell_generation_failed: '前端生成失败',
  translation_generation_failed: '出海翻译失败',
  translation_region_edit_started: '出海翻译单张修改开始',
  translation_region_edit_succeeded: '出海翻译单张修改成功',
  translation_region_edit_failed: '出海翻译单张修改失败',
  translation_region_edit_cancelled: '出海翻译单张修改取消',
  one_click_planning_failed: '一键策划失败',
  one_click_image_generation_failed: '一键出图失败',
  storyboard_board_regenerate_failed: '分镜板重生失败',
  storyboard_board_generation_failed: '分镜板生成失败',
  ...
  clear_first_image_config: '清空首图配置',
  clear_sku_config: '清空SKU配置',
  ...
  download_first_image_batch: '批量导出首图',
  ...
  diagnosis_probe: '视频诊断勘探',
  diagnosis_analyze: '视频诊断分析',
  clear_video_records: '清空视频记录',
  delete_video_record: '删除视频记录',
  download_video: '下载视频结果',

  confirm_storyboard_imaging: '确认分镜成图',
  ...
  task_regenerate_failed: '任务重新生成失败',
