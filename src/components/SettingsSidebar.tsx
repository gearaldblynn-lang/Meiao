            ...
            <div className="flex gap-2">
                ...
                >
                  <span className="inline-flex items-center gap-1">
                    ...
                    {m === 'gpt-image-2' ? (
                      <span className="rounded-full px-1.5 py-0.5 text-[8px] font-black" style={{ background: config.model === m ? 'rgba(255,255,255,0.16)' : 'var(--accent-soft)', color: config.model === m ? '#fff' : 'var(--accent)' }}>
                        推荐
                      </span>
                    ) : null}
                  </span>
              ...
              {qualityOptions.map((q) => (
                ...
                >
                  <span className="inline-flex items-center gap-1">
                    {q.label}
                    {q.value === '1k' ? (
                      <span className="rounded-full px-1.5 py-0.5 text-[8px] font-black" style={{ background: config.quality === q.value ? 'rgba(255,255,255,0.16)' : 'var(--accent-soft)', color: config.quality === q.value ? '#fff' : 'var(--accent)' }}>
                        推荐
                      </span>
                    ) : null}
                  </span>
