...
- Environment: local development / shell project hydration and persistence / product restoration.
...
- Regression check: 产品还原真实本地 state + jobs 回放只得到一个 canonical 项目；真实浏览器原图精修错误卡 0、产品还原目标卡 1、控制台 error 0；全量 `lint/test/build`。
