...
| `MEIAO_VOICEOVER_READINESS_MODEL_TIMEOUT_MS` | `60000` | 整数 `30000-90000`；仅用于冷启动模型 load gate |
| `MEIAO_VOICEOVER_READINESS_RETRY_DELAY_MS` | `15000` | 整数 `5000-300000`；首次失败后只做一次后台复检 |
