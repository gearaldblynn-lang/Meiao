...
**日期：** 2026-07-15  
**状态：** 单视频基础能力已实施；批量增强见 `2026-07-15-batch-subtitle-removal-design.md`
...
本文件保留基础 provider、安全和单视频交互合同；批量任务栏、共享批次项目卡及单项重试以 [`2026-07-15-batch-subtitle-removal-design.md`](./2026-07-15-batch-subtitle-removal-design.md) 为准。
...
- `videoName` 严格使用四段权威像素区域：`x1_y1_x2_y2`；不得拼入任务、批次或文件名前缀。
