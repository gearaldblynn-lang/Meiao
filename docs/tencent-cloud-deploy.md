...
# 虚拟模特手动上传与 AI 自动入库共享的保守重编码目标；不改像素宽高/DPI。
MEIAO_VIRTUAL_MODEL_IMAGE_TARGET_BYTES=3145728
